...
export const Sidebar: React.FC<SidebarProps> = ({ models, selectedModel, onSelectModel, isOpen = false, setIsOpen }) => {
    return (
        <>
            {/* Mobile Overlay */}
            <div
            ...
            <aside className={`fixed md:relative z-50 w-72 bg-surface/95 md:bg-surface/50 backdrop-blur-xl border-r border-white/10 h-screen flex flex-col transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
